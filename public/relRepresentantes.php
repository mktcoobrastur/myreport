  ...
  table {
    font-size: 12px;
          ...
          <div style="background: #165C80;
                      ...
                      font-size: 30px;
                      color: #f0f0f0;
                      text-shadow: 2px 2px 15px #333;">Relatório geral REPRESENTANTES</div>

<div class="text-center" style="margin: 2%;"> 
          <div class="box" style="float: left; box-shadow: 2px 2px 15px #ccc; width: 50%;">
              <div class="box-header">
                <h3 class="box-title">Vendas por Representante</h3>
              </div>
              <!-- /.box-header -->
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="progress progress-xs">
                        <div class="progress-bar progress-bar-primary progress-bar-striped" style="width:<?php echo $l['qnt']; ?>%;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </td>
  ...
  <?php
      //Consulta GERAL
      $consultaT = mysqli_query($con, "SELECT * FROM vendasre");
      $total = mysqli_num_rows($consultaT);
  ?>
                              
                  <tr>
                    <td>#</td>
                    <td align="left">Geral Representantes</td>
                    <td>
                      <div class="progress progress-xs">
