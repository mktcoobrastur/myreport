...
define('DEST_DIR', __DIR__ . '/imgatendentes');
    ...
    for ($i = 0; $i < $total; $i++)
    {
        ...
        //$query = "INSERT INTO anexos (Id, anexo, id_anexo) VALUES('0000','$anexo','$idChamado')";
			...
			if (!$conn) {
             ...
             $query = "UPDATE atendentes SET img='$anexo' WHERE id=$idChamado";
			...
			//echo "ok!";
        	header("Location:http://webdesigner2/sistema/public/atendentes/$idChamado");
