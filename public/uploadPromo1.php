...
if (isset($_FILES['arquivos']) && !empty($_FILES['arquivos']['name']))
{
    ...
    for ($i = 0; $i < $total; $i++)
    {
        ...
        //$query = "INSERT INTO anexos (Id, anexo, id_anexo) VALUES('0000','$anexo','$idChamado')";
			...
			$sql = "UPDATE promocoes SET imgPrincipal = '$anexo' where codigo = '$idChamado'";
			...
			echo "ok!";
        	header("Location:http://webdesigner2/sistema/public/promocoes/$redirect");
