...
@section('content')
    ...
    @include('chamados.topo')
        <a href="<?php echo $_ENV['APP_URL']; ?>print.php?c={!! $chamado->id !!}" target="blank" class="btn btn-default pull-right">
...
<div class="alert">
    <h3 style='margin-left: 10px;'>Anexos</h3>
        ...
        ?>
		<a href="<?php echo $_ENV['APP_URL']; ?>imgchamados/<?php echo $linha['anexo']; ?>" style="text-decoration: none;" target="blank" class="anexos btn btn-primary">
    ...
    <div class="alert">
        <form action="<?php echo $_ENV['APP_URL']; ?>uploadChamados.php" method="post" enctype="multipart/form-data">
