...
.linkS {
    ...
    @yield('scripts')
       ...
       <footer class="rodape">
           ...
           <div class="um">
               <div class="qr" style="background-image: url(http://webdesigner2/sistema/public/img/01.jpg);"></div>
               <div class="qr" style="background-image: url(http://webdesigner2/sistema/public/img/02.jpg);"></div>
               <div class="qr" style="background-image: url(http://webdesigner2/sistema/public/img/03.jpg);"></div>
               <div class="qr" style="background-image: url(http://webdesigner2/sistema/public/img/04.jpg);"></div>

               <div class="qr" style="background-image: url(http://webdesigner2/sistema/public/img/05.jpg);"></div>
               <div class="qr" style="background-image: url(http://webdesigner2/sistema/public/img/06.jpg);"></div>
               <div class="qr" style="background-image: url(http://webdesigner2/sistema/public/img/07.jpg);"></div>
               <div class="qr" style="background-image: url(http://webdesigner2/sistema/public/img/08.jpg);"></div>
            </div>
           </div>
        </footer>
        <div class="suggest">
