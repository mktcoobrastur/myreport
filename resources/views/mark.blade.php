...
<li>
    ...
    <div class="timeline-item" style="background: #f0f0f0;">
        <h3 class="timeline-header"><a href="/markconvenios/<?php echo $linha['id']; ?>"><i class="fa fa-caret-right" aria-hidden="true"></i> <?php echo utf8_encode(strtoupper($linha['nome'])); ?></a>
        <a href="/markconveniados/create?r=<?php echo $linha['id']; ?>" class="btn btn-default btn-xs pull-right"><i class="fa fa-plus" aria-hidden="true"></i></a>
        </h3>
        ...
        <div class="timeline-footer">
            <?php while ($linha2 = mysqli_fetch_array($query2)) { ?>
                <a class="btn btn-danger btn-xs" href="/markconveniados/<?php echo $linha2['id']; ?>"><?php echo strtoupper(utf8_encode($linha2['nome'])); ?></a>
            <?php } ?>                
        </div>
        </div>
