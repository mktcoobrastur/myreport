    ...
    @foreach($relacionamentos as $relacionamentos)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('relacionamentos.show', [$relacionamentos->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('relacionamentos.edit', [$relacionamentos->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
